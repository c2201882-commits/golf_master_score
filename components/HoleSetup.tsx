  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-6 max-w-md mx-auto">
      <div className="text-center mb-10">
        <div className="text-primary font-bold tracking-widest uppercase mb-2">Tee Off</div>
        <h2 className="text-4xl font-extrabold text-gray-900">Hole {state.currentHole}</h2>
        <p className="text-gray-500 mt-2">Select Par for this hole</p>
      </div>
      ...
      <div className="grid grid-cols-1 w-full gap-4">
        {[3, 4, 5].map((par) => (
          ...
          >
            <span className="text-2xl font-bold text-gray-800 group-hover:text-primary">Par {par}</span>
          </button>
        ))}
      </div>
