  ...
  return (
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="bg-white px-4 py-3 shadow-sm flex justify-between items-center sticky top-0 z-10">
        <div>
           <div className="text-xs text-gray-500 font-bold uppercase tracking-wide">Hole {state.currentHole}</div>
           <div className="text-xl font-black text-gray-800">Par {state.currentPar}</div>
        </div>
        <div className="flex flex-col items-end">
            <div className="text-xs text-gray-500 font-bold uppercase tracking-wide">Strokes</div>
      ...
      <div className="flex-1 overflow-y-auto p-4 pb-48 no-scrollbar">
          ...
          <div className="mb-6 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
             <div className="bg-gray-50 px-4 py-2 text-xs font-bold text-gray-400 uppercase border-b flex justify-between items-center">
                ...
                <span className="text-[10px] text-gray-400 font-normal normal-case">Tap to edit</span>
             </div>
      ...
      {showEditModal && (
          <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
              <div className="bg-white w-full max-w-sm rounded-2xl p-6 shadow-2xl animate-slide-up">
                  ...
                  <div className="mb-6">
                      <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Club Used</label>
                  ...
                  {/* Distance Input */}
                  <div className="mb-8">
                      <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Distance (Yards)</label>
                      <input 
                        ref={distInputRef}
                        type="number" 
                        inputMode="numeric"
