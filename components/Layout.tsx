          ...
          <div className="p-4 bg-green-50 border-b border-green-100">
             ...
             {isEditingName ? (
               <div className="flex gap-2">
                 ...
                 />
                 <button onClick={saveName} className="text-xs bg-primary text-white px-2 rounded">Save</button>
               </div>
             ) : (
               <div className="flex justify-between items-center">
                 <span className="text-lg font-bold text-gray-800">{state.userName}</span>
                 <button onClick={() => setIsEditingName(true)} className="text-xs text-primary underline">Edit</button>
               </div>
             )}
          </div>
